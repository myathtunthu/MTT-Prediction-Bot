...
def home():
    ...
    <ul>
        <li><a href="/setwebhook">/setwebhook</a> - Setup webhook</li>
        <li><a href="/test">/test</a> - Test bot connection</li>
        <li><a href="/getwebhook">/getwebhook</a> - Check webhook status</li>
    </ul>
    <p><strong>Note:</strong> Render automatically handles HTTPS</p>
    """
...
def set_webhook():
    ...
    try:
        # Use the actual host from request (Render handles HTTPS)
...
if __name__ == '__main__':
    ...
    print("✅ No HTTPS redirect - Render handles it automatically")
